...
export function WhatsAppButton() {
  ...
  // Hide button on the product details page
  ...
  const phoneNumber = getWhatsAppNumber(settings?.phone);
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white px-5 py-3.5 rounded-full shadow-[0_10px_40px_rgba(37,211,102,0.4)] flex items-center justify-center hover:bg-[#1ebe57] hover:scale-105 transition-all duration-300 group gap-2.5 border border-[#25D366]/50 backdrop-blur-md"
    ...
    >
      ...
      <span className="hidden md:inline font-bold text-sm tracking-wide">Fale Conosco</span>
    </motion.a>
  );
}
